...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function make_config(args) {
	  ...
	  underscore.each(['row', 'col'], function (inst_rc) {
	    ...
	    inst_nodes.forEach(function (d, i) { // Where calls are breaking. foEach takes a function in. d = item, i=index
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function brush_crop_matrix(xy = null) {
	  ...
	  function find_cropped_nodes(x_start, x_end, y_start, y_end, brush_start, brush_end) {
		...
		//CHANGED
		  // Whenever called, save the selected nodes for later access
	    console.log(found_nodes);
	    // Very hacky. Only returns row right now. But hey, it's a string.
	  ...
	  row.append('div').classed('clust_icon', true).style('float', 'left').style('width', width_pct).style('padding-left', padding_left).style('padding-right', '-5px').append('i').classed('fa', true).classed('fa-crop', true).classed('crop_button', true).classed('icon_buttons', true).style('font-size', '25px').on('click', function () {
	    ...
	    if (cgm.params.dendro_filter.row === false && cgm.params.dendro_filter.col === false) {
	      ...
	      if (is_crop) {
	        ...
	        // CHANGED
			//   console.log("Alright: are they saved?")
			//   console.log(saved_selected_nodes)
...
/******/
	...
	/* 278 */
	// CHANGED
	(function get_saved_selected_nodes(module, exports){
		...
		module.exports = function get_selected_nodes() {
			console.log("request for nodes made");
			console.log(saved_selected_nodes);
			return saved_selected_nodes;
		};
	}),
