...
import sys
sys.path.insert(0, "/Users/jinzhao/qsr_mwe/strands_qsr_lib/qsr_lib/src")
...
def pretty_print_world_qsr_trace(which_qsr, qsrlib_response_message):
    ...
    for t in qsrlib_response_message.qsrs.get_sorted_timestamps():
        foo = str(t) + ": "
        # qsrlib_response_message.qsrs.trace[0] is <qsrlib_io.world_qsr_trace.World_QSR_State object>
        # qsrlib_response_message.qsrs.trace[0].qsrs is <qsrlib_io.world_qsr_trace.QSR object>
        # qsrlib_response_message.qsrs.trace[t].qsrs.keys() is a list of a string, like ['o1,o2,o3']
...
if __name__ == "__main__":
    ...
    o2 = [Object_State(name="o2", timestamp=0, x=0., y=2., xsize=5., ysize=8.),
        Object_State(name="o2", timestamp=1, x=200., y=2., xsize=5., ysize=8.),
    ...
    # world.add_object_track_from_list([(3.,3.,5.2,8.5),(1.,1.,5.,8.),(1.,1.,5.,8.)], "o3")
