...
class QSRlib(object):
    ...
    def request_qsrs(self, req_msg):
        ...
        world_qsr_traces = []  # a list of `World_QSR_Trace <qsrlib_io.world_qsr_trace.World_QSR_Trace>`
        ...
        for which_qsr in which_qsrs:
            # qsr_rcc8.get_qsrs function is defined in src/qsrlib_qsrs/qsr_abstractclass.py, and it returns a `World_QSR_Trace <qsrlib_io.world_qsr_trace.World_QSR_Trace>`
