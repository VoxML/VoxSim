...
public class GestureInputModalWindow : ModalWindow {
	...
	List<string> gestureInputs = new List<string>();
	...
	public override void DoModalWindow(int windowID){
		...
		foreach (string input in gestureInputs) {
	...
	void ReceivedGesture(object sender, EventArgs e) {
		gestureInputs.Add (((GestureEventArgs)e).Content.Split (';') [0]);
