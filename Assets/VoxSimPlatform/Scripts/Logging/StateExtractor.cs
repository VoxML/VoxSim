        ...
        public class StateExtractor : MonoBehaviour {
        	...
        	void QueueEmpty(object sender, EventArgs e) {
        		...
        		foreach (Voxeme voxeme in objectSelector.allVoxemes) {
        			if (!objectSelector.disabledObjects.Contains(Global.Helper.GetMostImmediateParentVoxeme(voxeme.gameObject))) {
        				objList.Add(Global.Helper.GetMostImmediateParentVoxeme(voxeme.gameObject));
        			}
        		}
