...
namespace Crosstales.RTVoice.EditorExt
{
    ...
    public abstract class ConfigBase : EditorWindow
    {
        ...
        private static Vector2 scrollPosAboutUpdate;
        private static Vector2 scrollPosAboutReadme;
        private static Vector2 scrollPosAboutVersions;
        ...
        protected static void showAbout()
        {
            ...
            tab = GUILayout.Toolbar(tab, new string[] { "Update", "README", "VERSIONS" });
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                //if (GUILayout.Button(new GUIContent(string.Empty, EditorHelper.Social_Youtube, "Follow us on 'Youtube'.")))
                //{
                //	Application.OpenURL(Util.Constants.ASSET_SOCIAL_YOUTUBE);
                //}
