...
//We have run the builder shell with "sample_build_config.xml", Unity popped up and disappeared, 
//no errors but the .app file wasn't created. 
//Is there a correct way to run it? should we use the "sample_build_config.xml" or do we need more than it? 
